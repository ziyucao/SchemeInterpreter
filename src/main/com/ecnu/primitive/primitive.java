...
//        return (x instanceof Integer)||(x instanceof Float)&&(!(x instanceof Boolean));
    ...
    public static int scheme_add(Object[] a) {
        ...
        for (int i = 0; i < a.length; i++) {
            try {
                ...
                ErrorInfo.setPosition(SchemeList.findByToken(a[i].toString()));
                ErrorInfo.setError("TYPE_ERROR");
            }
        }
        return result;
    }
    ...
    public static int scheme_sub(Object[] a) {
        ...
        try {
            ...
            ErrorInfo.setPosition(SchemeList.findByToken(a[0].toString()));
            ErrorInfo.setError("TYPE_ERROR");
        }
    ...
    public static int scheme_div(Object[] a) {
        ...
        for (int i = 1; i < a.length; i++) {
            try {
                ...
                ErrorInfo.setError("程序出现异常，除数不能为0。");
            } catch (Exception e) {
                ErrorInfo.setPosition(SchemeList.findByToken(a[i].toString()));
                ErrorInfo.setError("TYPE_ERROR");
            }
    ...
    public static int scheme_quo(int val1, int val2) {
        ...
        try {
            ...
            ErrorInfo.setError("程序出现异常，求商时除数不能为0。");
        }
        return result;
    ...
    public static int scheme_modulo(int val1, int val2) {
        ...
        try {
            ...
            ErrorInfo.setError("程序出现异常，求余数时除数不能为0。");
        }
        return result;
    }
